...
public struct TimelineLayoutEngine {
    public static let timelineStartHour = 5
    public static let timelineHourHeight: CGFloat = 64
    public static let timelineThirtyMinuteHeight: CGFloat = 32

    public static func yPosition(for date: Date, calendar: Calendar) -> CGFloat {
    ...
    public static func dateForTimelinePosition(_ y: CGFloat, selectedDate: Date, calendar: Calendar) -> Date {
    ...
    public static func hasTimeConflict(
        newStart: Date,
        durationMinutes: Int,
