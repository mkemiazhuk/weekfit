  ...
  ru: [
    {
      ...
      blocks: [
        {
          t: "p",
          v: "Большинство советов про сон не работают по одной причине: они требуют «пересобрать» жизнь. Здесь наоборот — несколько **небольших шагов**, которые улучшат сон уже сегодня, даже если день был хаотичным.",
        },
        { t: "quote", v: "Хороший сон — это чаще система, а не лайфхак." },
      ],
    },
    {
      id: "two-hour-runway",
      ...
      blocks: [
        {
          t: "p",
          v: "Идеальный вечерний ритуал не нужен. Нужна граница между «днём» и «сном». Простое правило: **последние два часа — под сон**.",
        },
        {
          t: "ul",
          v: [
            "Сделайте последние 2 часа **узнаваемыми** (одинаковый порядок действий, не обязательно одинаковое время).",
            "«Тяжёлую голову» — раньше: планы на завтра, сложные письма, напряжённые разговоры.",
            "Поздняя тренировка — пусть будет лёгкой: прогулка, мобилити, спокойная силовая. Жёсткие интервалы перед сном часто дают беспокойную ночь.",
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        {
          t: "p",
          v: "Биологические часы сильнее реагируют на свет, чем на «силу воли». Две вещи решают больше всего: **ярко утром** и **мягко вечером**.",
        },
        {
          t: "ul",
          v: [
            "В течение часа после подъёма — на улицу на 5–10 минут (даже если пасмурно).",
            "После заката — тёплый, приглушённый свет; по возможности уберите яркий верхний.",
            "Если без телефона никак — снизьте яркость и не «залипайте» в постели: мозг быстро учится, что кровать = контент, а не сон.",
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        {
          t: "p",
          v: "Кофеин не «исчезает» в тот момент, когда вы перестали его чувствовать. У многих поздний кофе незаметно режет глубокий сон.",
        },
        {
          t: "ul",
          v: [
            "Если сон хрупкий — попробуйте на неделю убрать кофеин за **8–10 часов** до сна и посмотрите разницу.",
            "Если обычно всё ок — всё равно помогает более ранний «стоп» (6–8 часов).",
            "Энергетики часто бьют сильнее, чем кажется: не только кофеин, но и время + скачки сахара.",
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        {
          t: "p",
          v: "Засыпание начинается, когда тело «остывает». Поэтому слегка прохладная комната часто работает лучше, чем «уютно жарко».",
        },
        {
          t: "ul",
          v: [
            "Сделайте спальню прохладнее (или просто возьмите более лёгкое одеяло).",
            "Тёплый душ за 60–90 минут до сна часто помогает: кожа согревается, а потом «ядро» остывает.",
            "Холодные стопы легко удерживают в бодрствовании: тёплые носки иногда эффективнее любой добавки.",
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        {
          t: "p",
          v: "Просыпаться — нормально. Проблема в том, что потом включается «раскрутка». Задача — **не дать пробуждению разрастись**.",
        },
        {
          t: "ul",
          v: [
            "Не смотрите на часы — иначе одно пробуждение превращается в «оценку ночи».",
            "Если бодрствуете > 15–20 минут — встаньте ненадолго, оставьте свет минимальным, почитайте пару страниц и вернитесь.",
            "Не «спасайтесь» экраном: яркий свет быстрее всего окончательно будит мозг.",
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        {
          t: "p",
          v: "WeekFit не просто считает часы. Он смотрит на сон вместе с сигналами восстановления (ВСР, пульс покоя) и вашим планом. Если ночь была короткой или рваной, Коуч скорее предложит спокойнее нагрузку, ровнее питание и более раннее восстановление — чтобы завтра было проще.",
        },
      ],
    },
    {
