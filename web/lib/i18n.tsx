...
const en = {
  ...
  hero: {
    ...
    coachBody: "Recovery is strong. Yesterday's ride left muscular fatigue — train, but hold intensity.",
...
const ru: Dict = {
  ...
  hero: {
    ...
    coachBody: "Восстановление сильное. Вчерашняя поездка оставила мышечную усталость — тренируйтесь, но без пика.",
