    ...
    categories: [
      {
        ...
        faqs: [
          { q: "Do I need an account to use WeekFit?", a: "Yes — tap Sign in with Apple on the welcome screen. WeekFit still keeps your health and plan data on-device; Sign in with Apple is for your local workspace identity, not a cloud feed." },
          ...
          { q: "What is WeekFit Premium?", a: "WeekFit Premium unlocks the full coaching experience via an App Store subscription. Eligible App Store accounts may see a free trial; prices follow your storefront. Manage or cancel anytime in Apple Subscriptions." },
        ],
      },
      {
        icon: "health",
    ...
    categories: [
      {
        ...
        title: "Быстрый старт",
        faqs: [
          { q: "Нужен ли аккаунт?", a: "Да — нажмите «Войти через Apple» на экране приветствия. Данные о здоровье и плане по-прежнему остаются на устройстве: вход нужен для локального пространства, это не облачная лента." },
          ...
          { q: "Что такое WeekFit Premium?", a: "WeekFit Premium открывает полный опыт коучинга через подписку в App Store. При eligibility может быть пробный период; цены зависят от витрины. Управлять или отменить можно в подписках Apple." },
        ],
      },
      {
        icon: "health",
...
> = {
  en: {
    ...
    facts: [
      ...
      { label: "Price", value: "Free with WeekFit Premium" },
      { label: "Launch", value: "2026" },
      { label: "Website", value: "weekfit.app" },
    ],
    boilerTitle: "Boilerplate",
    boilerShort:
      "WeekFit is your AI coach, powered by Apple Health. One clear call for today — what to do now, why it matters, and how to adjust. Home Screen widgets keep Move, Fuel, Ready, and what's next in view. WeekFit Premium is available as an App Store subscription. Private on your iPhone.",
    boilerLong: "WeekFit is your AI coach for iOS, powered by Apple Health. Instead of another dashboard of numbers, it turns sleep, activity, nutrition and recovery into one clear call for today — what to do now, why it matters, and how to adjust. Home Screen widgets show Move, Fuel, Ready, and what's next. Completed workouts from Apple Health update the matching Plan slot, even when you go longer than planned. WeekFit Premium unlocks the full coaching experience via App Store subscription, with a free trial when eligible. Private by design: Sign in with Apple for your workspace, health data stays on-device, and WeekFit never uses it for advertising.",
  ...
  ru: {
    ...
    facts: [
      ...
      { label: "Цена", value: "Бесплатно + WeekFit Premium" },
      { label: "Запуск", value: "2026" },
      { label: "Сайт", value: "weekfit.app" },
    ],
    boilerTitle: "Описание",
    boilerShort:
      "WeekFit — ваш AI-коуч на основе Apple Health. Один понятный вывод на сегодня — что делать сейчас, почему это важно и как подстроиться. Виджеты показывают нагрузку, еду, форму и что дальше. WeekFit Premium доступен как подписка в App Store. Приватно на iPhone.",
    boilerLong: "WeekFit — спокойный AI-коуч для iOS. Вместо очередной панели с цифрами он видит связи между сном, активностью, питанием и восстановлением — на основе Apple Health и с обработкой прямо на устройстве — и объясняет, что важно сегодня и как к этому подготовиться. Виджеты на экране «Домой» показывают нагрузку, еду, форму и что дальше. Тренировки из Apple Health обновляют слот в Плане, даже если вышли длиннее плана. WeekFit Premium открывает полный опыт коучинга через подписку App Store, с пробным периодом при eligibility. Приватность заложена в основу: вход через Apple для локального пространства, данные о здоровье остаются на устройстве и никогда не используются для рекламы.",
...
> = {
  en: {
    ...
    lead: "WeekFit is free on the App Store, with WeekFit Premium available as a subscription. Built around Apple Health, private by design.",
  ...
  ru: {
    ...
    lead: "WeekFit бесплатно в App Store, WeekFit Premium — по подписке. Работает на данных Apple Health, приватность — в основе.",
    reqTitle: "Требования",
    requirements: [
