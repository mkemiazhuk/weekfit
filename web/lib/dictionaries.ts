export const en = {
  ...
  hero: {
    ...
    titleA: "What is",
    titleB: "today for?",
    lead: "One decision every morning — push, hold, or recover. With a reason in ten seconds.",
    decision: "Move today. Not hard.",
    coachTitle: "Move today.",
    coachBody: "Strong recovery. Residual ride fatigue — move today, push tomorrow.",
    ctaSecondary: "Try it live",
    scroll: "See how it thinks",
  },
  proof: {
...
export const ru: Dict = {
  ...
  hero: {
    ...
    titleA: "Для чего",
    titleB: "сегодня?",
    lead: "Одно решение каждое утро — давить, держать или восстанавливаться. С причиной за десять секунд.",
    decision: "Движение сегодня. Без пика.",
  ...
  experience: {
    kicker: "Симулятор вторника",
    title: "Почувствуйте завтрашнее утро.",
    lead: "Настройте сигналы прошлой ночи. WeekFit сделает вывод — та же логика, что в приложении.",
    setupKicker: "Прошлая ночь",
    sleepLabel: "Сон",
    hrvLabel: "ВСР к базе",
    loadLabel: "Нагрузка вчера",
    setupNote: "Упрощённая логика для беты. Реальный вывод — из Apple Health на вашем iPhone.",
    resultKicker: "Это утро",
    ...
    decisions: {
      push: {
        headline: "Давить сегодня.",
        subline: "Восстановление сильное, вчера было легко.",
        reason:
          "Сон и ВСР поддерживают интенсив. Мышечная усталость низкая — сегодня подходит hard day.",
      },
      hold: {
        headline: "Движение сегодня. Без пика.",
        subline: "Готовность хорошая, но вчера ещё слышно.",
        reason:
          "Сердечно-сосудистое восстановление в порядке. Остаточная нагрузка — двигайтесь, пик оставьте на завтра.",
      },
      recover: {
        headline: "Восстановление сегодня.",
        subline: "Сон или нагрузка просят сбавить.",
        reason:
          "Мало сна или просевшая ВСР. Лёгкий день защитит завтрашний вывод.",
      },
    },
    closing: "Завтра в 7:00 реальный вывод будет на вашем iPhone.",
    backHome: "На главную",
  },
  morning: {
    kicker: "Утро",
  ...
  cta: {
    ...
    appStoreFootnote: "App Store — после публичной беты.",
  },
  footer: {
    ariaLabel: "Подвал сайта",
    tagline: "Для чего сегодня? Одно спокойное решение каждое утро.",
