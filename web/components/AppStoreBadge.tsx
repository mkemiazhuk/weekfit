  ...
  return (
    ...
    >
      <a
        ...
        className="inline-flex items-center gap-3 rounded-button border border-white/10 bg-black/40 px-5 py-3 transition-[opacity,background,border-color] duration-200 hover:border-white/20 hover:bg-black/55"
      >
      ...
      {footnote && (
        <span className="max-w-[28ch] text-[12px] leading-relaxed text-white/35">{footnote}</span>
      )}
    </div>
  );
}
