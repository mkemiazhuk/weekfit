...
final class CoachV6TabPresentationBridgeTests: XCTestCase {
    ...
    func testBridgeReturnsNilWhenCopyPackMissing() {
        ...
        let insight = CoachV6TodayInsight(
            scenario: .duringStrength,
            modifiers: modifiers,
            semanticColor: .live,
            alertSeverity: .none,
        ...
        let result = CoachV6Engine.Result(
            context: context,
        ...
        XCTAssertNil(CoachV6TabPresentationBridge.build(from: result))
    }
    ...
    private func makeInput(
        ...
        return CoachInputSnapshot(
            ...
            source: "CoachV6TabPresentationBridgeTests"
        )
    }
