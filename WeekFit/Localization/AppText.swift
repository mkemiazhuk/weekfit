...
enum AppText {
    ...
    enum Login {
        ...
        static let recoveryValueFormat: LocalizedStringResource = "login.card.recovery.valueFormat"
    ...
    enum Settings {
        ...
        enum Profile {
            ...
            static let signOut: LocalizedStringResource = "settings.profile.signOut"
