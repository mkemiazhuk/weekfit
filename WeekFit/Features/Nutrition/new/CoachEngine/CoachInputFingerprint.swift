...
struct CoachInputFingerprint: Hashable, CustomStringConvertible {
    ...
    init(snapshot: CoachInputSnapshot) {
        ...
        rawValue = [
            ...
            "activityCircleActiveCalories=\(Self.rounded(actualLoad.activeCalories))",
            "activityCircleExerciseMinutes=\(actualLoad.exerciseMinutes ?? -1)",
            "activityCircleProgress=\(Self.rounded(actualLoad.activityProgress ?? -1))",
