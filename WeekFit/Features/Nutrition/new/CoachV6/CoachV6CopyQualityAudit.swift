...
enum CoachV6CopyQualityAudit {
    ...
    static func audit(pack: CoachV6CopyPack, input: CoachV6CopyBuildInput) -> Report {
    ...
    private static func nonEmptySectionChecks(_ pack: CoachV6CopyPack) -> [String] {
        var issues: [String] = []
    ...
    private static func bilingualChecks(_ pack: CoachV6CopyPack) -> [String] {
        var issues: [String] = []
    ...
    private static func lengthChecks(_ pack: CoachV6CopyPack) -> [String] {
        var issues: [String] = []
    ...
    private static func duplicateChecks(_ pack: CoachV6CopyPack) -> [String] {
        let mainSections: [(String, CoachV6CopySection)] = [
    ...
    private static func crossSectionOverlapChecks(_ pack: CoachV6CopyPack) -> [String] {
        var issues: [String] = []
        let pairs: [(String, CoachV6CopySection, String, CoachV6CopySection)] = [
    ...
    private static func supportingSignalCountCheck(_ pack: CoachV6CopyPack) -> [String] {
    ...
    private static func sectionPairs(_ pack: CoachV6CopyPack) -> [(String, CoachV6CopySection)] {
        [
            ("assessment", pack.assessment),
            ("recommendation", pack.recommendation),
            ("avoid", pack.avoid),
    ...
    private static func section(named name: String, pack: CoachV6CopyPack) -> CoachV6CopySection {
        switch name {
    ...
    private static func allText(in section: CoachV6CopySection) -> [String] {
    ...
    private static func sectionsShareSignificantPhrase(
        _ lhs: CoachV6CopySection,
        _ rhs: CoachV6CopySection
    ) -> Bool {
    ...
    private static func significantPhrases(in section: CoachV6CopySection) -> Set<String> {
