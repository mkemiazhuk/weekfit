...
enum CoachSessionPhaseStability {
    ...
    static func isCoachLiveSession(_ activity: PlannedActivity, now: Date) -> Bool {
    ...
    static func treatsCompletedAsLive(activity: PlannedActivity, now: Date) -> Bool {
    ...
    private static func isStabilityEligible(_ activity: PlannedActivity) -> Bool {
    ...
    private static func plannedSessionEnd(for activity: PlannedActivity) -> Date {
