...
private extension TermsPrivacyView {
        ...
        VStack(alignment: .leading, spacing: 22) {
            ...
            legalSection(
                ...
                paragraphs: [
                    ...
                    "WeekFit may use privacy-preserving product analytics and crash diagnostics to improve the app. These reports do not include HealthKit sample values, meal titles, or coach message text, and are not used for advertising. Optional feedback you choose to send goes to support via email. See the full privacy policy for details.",
    ...
    var russianLegalCopy: [String: String] {
        [
            ...
            "WeekFit may use privacy-preserving product analytics and crash diagnostics to improve the app. These reports do not include HealthKit sample values, meal titles, or coach message text, and are not used for advertising. Optional feedback you choose to send goes to support via email. See the full privacy policy for details.": "WeekFit может использовать бережную продуктовую аналитику и диагностику сбоев, чтобы улучшать приложение. В этих отчётах нет значений HealthKit, названий блюд и текста коуча, и они не используются для рекламы. Обратную связь, которую вы сами отправляете, получает поддержка по email. Подробности — в полной политике приватности.",
