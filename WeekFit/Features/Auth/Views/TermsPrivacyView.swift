...
struct TermsPrivacyView: View {
    ...
    private var textMuted: Color { WeekFitTheme.tertiaryText }
...
private extension TermsPrivacyView {
        ...
        VStack(alignment: .leading, spacing: 22) {
            ...
            legalSection(
                ...
                paragraphs: [
                    ...
                    "WeekFit uses Firebase Analytics for product usage measurement when you enable Share Product Analytics in Settings. Firebase Crashlytics is used for crash diagnostics. These services do not receive raw HealthKit data, derived health or recovery information, sleep status, meal contents, barcodes, coach message text, or other personal health content. Analytics is off until you opt in. See the full privacy policy for details.",
                    "If future features require account services or cloud sync of your plan, those features will be disclosed separately and handled according to the app privacy policy and applicable App Store requirements."
                ]
            )
    ...
    var russianLegalCopy: [String: String] {
        [
            ...
            "WeekFit uses Firebase Analytics for product usage measurement when you enable Share Product Analytics in Settings. Firebase Crashlytics is used for crash diagnostics. These services do not receive raw HealthKit data, derived health or recovery information, sleep status, meal contents, barcodes, coach message text, or other personal health content. Analytics is off until you opt in. See the full privacy policy for details.": "WeekFit использует Firebase Analytics для измерения использования продукта, если вы включите «Делиться продуктовой аналитикой» в настройках. Firebase Crashlytics используется для диагностики сбоев. Эти сервисы не получают сырые данные HealthKit, производные сведения о здоровье или восстановлении, статус сна, содержимое приёмов пищи, штрихкоды, текст коуча или другой персональный контент о здоровье. Аналитика выключена, пока вы не включите её. Подробности — в полной политике приватности.",
            "If future features require account services or cloud sync of your plan, those features will be disclosed separately and handled according to the app privacy policy and applicable App Store requirements.": "Если будущие функции потребуют аккаунта или облачной синхронизации плана, это будет раскрыто отдельно и обработано согласно политике приватности и требованиям App Store.",
